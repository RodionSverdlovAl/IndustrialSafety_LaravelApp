...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-dark elevation-4">
        ...
        <a href="#" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Охрана труда</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="#" class="d-block">Админ: {{auth()->user()->name . " " . auth()->user()->surname}}</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.incident.index')}}" class="nav-link">
                            <i class="nav-icon far fa-image"></i>
                            <p>
                                Инцеденты
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.assessment.index')}}" class="nav-link">
                            <i class="nav-icon far fa-image"></i>
                            <p>
                                Оценки
                            </p>
